...
for i in range(len(dir_list)):
    ...
    doc_name = math.floor(i / 100)
    if not os.path.exists(r"F:\pdf_word\{}".format(doc_name)):
        os.makedirs(r"F:\pdf_word\{}".format(doc_name))
    shutil.move("{}\{}".format(doc_name_, dir_list[i - 1]), r"F:\pdf_word\{}\{}".format(doc_name, dir_list[i - 1]))
